...
function fetchDistricts(geoState) {
	...
	return function (dispatch) {
		...
		return _isomorphicFetch2['default']('https://localhost:8100/districts/').then(function (response) {
